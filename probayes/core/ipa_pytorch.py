...
class BackboneUpdate(nn.Module):
    ...
    def __init__(self, c_s, use_rot_updates, quat4_update=False):
        """
        Args:
            c_s:
                Single representation channel dimension
        ...
        update_dim = 7 if use_rot_updates and quat4_update else update_dim
    ...
    def forward(self, s: torch.Tensor):
        ...
        Args:
            [*, N_res, C_s] single representation
        Returns:
            [*, N_res, 6] update vector or [*, N_res, 7]
        """
        # [*, 6]
