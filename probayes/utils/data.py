...
from probayes.modules.protein.constants import PAD_RESIDUE_INDEX
...
class PaddingCollate(object):
    ...
    def __init__(self, length_ref_key='aa', pad_values=DEFAULT_PAD_VALUES, no_padding=DEFAULT_NO_PADDING, eight=True, max_length=2000):
        super().__init__()
