...
# from remote.Protenix.protenix.model.modules.diffusion import DiffusionModule

import math


class GAEncoder_Trans(nn.Module):
    ...
    def forward(self, t, rotmats_t, trans_t, angles_t, seqs_t, node_embed, edge_embed, generate_mask, res_mask):
        ...
        self.diffusion_module.forward(x_noisy=trans_t,
                                      t_hat_noise_level=t,
