...
from remote.dyMEAN.configs import IMGT, Chothia
...
class AgAbComplex:
    ...
    def __init__(self, antigen: Protein, antibody: Protein, heavy_chain: str, light_chain: str,
                 numbering: str='clothia', skip_epitope_cal=False, skip_validity_check=False) -> None:
    ...
    def _extract_antibody_info(self, antibody: Protein, numbering: str):
        ...
        # print('numbering scheme',numbering)
        if numbering == 'imgt':
            _scheme = IMGT
