...
from remote.ppflow.tools.dock.adcpdock import ADCPDock
from remote.ppflow.ppflow.utils.misc import get_logger
...
if __name__ == '__main__':
    ...
    pdb_names = sorted([f for f in os.listdir(args.gen_dir) if f.endswith('bb3.pdb')])[4:20]
