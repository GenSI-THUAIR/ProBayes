...
if __name__ == '__main__':
    ...
    # {"id": "1d4t", "number": 13, "gen_pdb": "/data/wuhl/bfn4pep/logs/bfn_quat_pepbench[dev-4e40e88][04-11-00-30-29]_quat_bfn_pepbench/checkpoints/results/candidates/1d4t/1d4t_gen_13.pdb", 
    # "ref_pdb": "/data/wuhl/bfn4pep/logs/bfn_quat_pepbench[dev-4e40e88][04-11-00-30-29]_quat_bfn_pepbench/checkpoints/results/references/1d4t_ref.pdb", "pmetric": 0, "rec_chain": "A", "lig_chain": "B", "ref_seq": "KSLTIYAQVQK", "gen_seq": "VFQGLISTANM", "seq_only": false, "struct_only": false, "backbone_only": false}

    parser.add_argument('--gen_dir', type=str, default='/data/wuhl/bfn4pep/logs/bfn_quat_pepbench[dev-4e40e88][04-11-00-30-29]_quat_bfn_pepbench/checkpoints/results/candidates/1d4t/')
    parser.add_argument('--ref_dir', type=str, default='/data/wuhl/bfn4pep/logs/bfn_quat_pepbench[dev-4e40e88][04-11-00-30-29]_quat_bfn_pepbench/checkpoints/results/references/1d4t_ref.pdb')
