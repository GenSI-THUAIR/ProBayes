...
class EvalTask:
    ...
    cdrh3_seq: Optional[str] = None
    cdrh3_reslist: Optional[List] = None
    ...
    def get_relaxed_ref_biopython_model(self):
        parser = PDB.PDBParser(QUIET=True)
        return parser.get_structure(self.relaxed_ref_path, self.relaxed_ref_path)[0]
